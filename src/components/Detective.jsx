...
const Detective = () => {
    ...
    return (
      <div>
        <Navbars/>
      <div className='Chats mt-5' style={{ backgroundColor: "white", color: "black", height: "100vh", fontFamily: 'Poppins, sans-serif', display: 'flex', alignItems:"center", justifyContent: "center" }}>
        ...
        <div className="main  " style={{  display: "flex", flexDirection: "column", justifyContent: "center",alignItems: "center", margin: "0.5rem", marginBottom: "5px" }}>
          ...
          <div className="chats" style={{ overflow: "hidden", overflowY: "scroll", scrollBehavior: 'smooth',width: "100%", maxWidth: "100rem", height: "calc(100vh - 15rem)",  }}>
            ...
            <div className="inp" style={{ padding: "5px", backgroundColor: "white", display: "flex", alignItems: "center", borderRadius: "0.5rem", width: "50rem", margin: "8px" }}>
              <input
                type="text"
  ...
  <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/>
            ...
            <p style={{ marginBottom: "15px", fontSize: "12px" }}>LearnEase may produce incorrect information about people, places or facts.</p>
          </div>
          </div>
          </div> 
