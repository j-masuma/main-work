...
//     return (
//         <Navbar expand="lg" className=" p-2  " fixed="top" style={{  background:"#05192d" }}>
...
//                     <Nav.Link href="#link">MONITOR PROGRESS</Nav.Link>
//                     <Nav.Link href="/study-plan-page">STUDY PLANS</Nav.Link>
