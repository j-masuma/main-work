...
//             <button className="midBtn btn btn-success btn-block p-2" style={{ width: "50%", height: "40px" }}>
//             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
//               <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
//             </svg>
//   <span style={{ paddingLeft: "5px" }}>New Chat</span>
// </button>

// </div>
//             <div id= "favChats" className="favChats">
//               {/* fav chats render */}
//               <button id="fav">favchat</button>
//               <button id="fav">favchat</button>
//               <button id="fav">favchat</button>
...
//     <div className="chat bot" style={{ width: "90%", textAlign: "justify", margin: "0.5rem", padding: "0.5rem 1rem", fontSize: "0.85rem", display: "flex", alignItems: "flex-start" }}>
//         <p className="txt">Lorem  incidunt aperiam obcaecati!</p>
//     </div>
//     <div className="chat bot" style={{ width: "90%", textAlign: "justify", margin: "0.5rem", padding: "0.5rem 1rem", fontSize: "0.85rem", display: "flex", alignItems: "flex-start" }}>
//         <p className="txt">Lorem  incidunt aperiam obcaecati!</p>
//     </div>
...
//         <div className="inp" style={{ padding: "5px", backgroundColor: "white", display: "flex", alignItems: "center", borderRadius: "0.5rem",  width: "95%", maxWidth: "65rem", margin:"5px", marginRight:"3px"}}>
//   {/* <input type="text" placeholder='Send a message' style={{ backgroundColor: "transparent", border: "none", width: "calc(100% - 3rem)", outline: "none", marginRight: "0.5rem" }} /> */}
//   <input 
//   type="text" 
...
//   </button>
// </div>
// <p style={{margin:"5px", fontSize:"12px"}}>LearnEase may produce incorrect information about people, places or facts.</p>
//         </div>
//       </div>
//     </div>
//   );
...
const Chats = () => {
  return (
    <div className='Chats' style={{ backgroundColor: "whitesmoke ", color: "black", height: "100vh", fontFamily: 'Poppins, sans-serif', display: 'flex' }}>
          <div className="sideBar" style={{ flex: "3", borderRight: "1px solid white", display: 'flex', flexDirection: 'column'  , padding: "10px"}}>
            <div className="upperSide">
            <div className="upperSideTop" style={{ paddingLeft: "10px", paddingTop: "10px" }}>
        <div style={{ display: "flex",  flexDirection: "column", alignItems: "center"}}>
          ...
          <div className="main" style={{minHeight:"calc(100vh-15rem)",display:"flex",flexDirection:"column",alignItems:"center",margin:"1rem", flex: "9", marginBottom:"5px" }} >
                <h2>Tutor Bot</h2>
                <div className="botTone">
                    <Button className='m-2' variant="outline-secondary">Tone</Button>{' '}
                    <Button className='m-2' variant="outline-secondary">Tone</Button>{' '}
                    <Button className='m-2' variant="outline-secondary">Tone</Button>{' '}
            ...
            <p className=" p-2">Lorem ipsum dolor sit amet consectetur adipisicing elit.  aperiam obcaecati!</p>
            </div>
            <div className="chat bot border rounded" style={{ textAlign: "justify", margin: "0.5rem", padding: "1rem 2rem", fontSize: "0.85rem", display: "flex", alignItems: "flex-start" }}>
                ...
                <p className="txt p-2">Lorem Lorem ipsum dolor sit, amet consectetur adipisicing elit. </p>
            </div>
    </div>
